    ...
    public  static HashMap<String, String >getRemoteMsgHeaders(){
        if(remoteMsgHeaders==null){
            ...
            remoteMsgHeaders.put(
                    ...
                    "key=AAAASlwy1H4:APA91bEG0MHXgsq6_dKUeKkASuP2UfWrPHVhFxmqkQFD9IPoYijZNA-cacWxPSfk84hAALue6-0NVzhSvXI4xcjUOP2OZYn246-6hbcr-R2iE8mUjzDUCwoL5Xv0I-AhytEUhUxPkvs_"
            );
            remoteMsgHeaders.put(
